...
export class AppComponent implements OnInit {
  title = 'class-quizz-app';
  activeQuestionIndex = 0;
  intervalId: any;
  timerInterval: any = 10;
  timeLeft: number = 10;
...
ngOnInit() : void {
  this.selectedQuestions = this.questions.slice(0, 10)
   this.intervalId = setInterval(()=>{ debugger
      if (this.activeQuestionIndex <this.selectedQuestions.length-1   ) { debugger
...
setGameOver(){
   if(this.activeQuestionIndex = this.selectedQuestions.length){ 
